...
final visualizerMetaProvider = FutureProvider.family<VisualizerMeta, String>((ref, name) async {
  return await ref.read(visualizerProvider).getVisualizerMeta(name);
});